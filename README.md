# PacketScope – Multi-threaded Deep Packet Inspection Engine in C++


This document explains **everything** about this project - from basic networking concepts to the complete code architecture. After reading this, We'll be able to  understand exactly how packets flow through the system without needing to read the code.
